  ...
  useEffect(() => {
    ...
    const handler = setTimeout(() => {
      backendClient
        ...
        .catch((err) => {
          console.error('Erro ao salvar configura��es', err);
        });
    }, 500);
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto glass-card">
        <DialogHeader>
          ...
          <DialogDescription className="text-muted-foreground">Gerencie credenciais da Binance e par�metros operacionais.</DialogDescription>
        </DialogHeader>
              ...
              <CardContent className="space-y-4">
                <Alert>
                  ...
                  <AlertDescription>
                    ...
                    saldos e enviar ordens autorizadas por voc�.
                  </AlertDescription>
                </Alert>
                ...
                <div className="flex items-center space-x-2 pt-4">
                  ...
                  <Badge variant="outline">Prote��o via controle de acesso local</Badge>
                </div>
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      Spread m�nimo para considerar uma opera��o.
                    </p>
                  </div>

                  <div>
                    <Label htmlFor="max-position">Posi��o M�xima (USDT)</Label>
                    <Input
                      id="max-position"
                      type="number"
                  ...
                  <div>
                    ...
                    />
                    <p className="text-xs text-muted-foreground mt-1">
                      Perda m�xima aceit�vel por opera��o.
                    </p>
                  </div>

                  <div>
                    <Label htmlFor="timeout">Timeout de Posi��o (s)</Label>
                    <Input
                      id="timeout"
                      type="number"
                    ...
                    />
                    <p className="text-xs text-muted-foreground mt-1">
                      Tempo m�ximo de exposi��o por opera��o.
                    </p>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Permite que o motor de IA ajuste dinamicamente estrat�gias.
                    </p>
                  </div>
                  <Switch
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <Label htmlFor="confidence">Confian�a m�nima (%)</Label>
                    <Input
                      id="confidence"
                      type="number"
          ...
          <TabsContent value="risk" className="space-y-6">
            <Card className="glass-card">
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="max-daily-loss">Perda di�ria m�xima (USDT)</Label>
                    <Input
                      id="max-daily-loss"
                      type="number"
                ...
                <div className="flex items-center justify-between rounded-md border p-4">
                  <div>
                    <p className="font-medium">Emerg�ncia</p>
